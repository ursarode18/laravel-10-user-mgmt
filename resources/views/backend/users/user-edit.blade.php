        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <form action="{{route('user-upd',$data->id)}}" class="row d-flex justify-content-center" method="POST">
                            @csrf
                            <div class="col-md-8 ">
                                <div class="mb-3">
                                    <label for="division" class="form-label">Full Name</label>
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $data->name }}" id="division">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" value="{{ $data->email }}" class="form-control @error('email') is-invalid @enderror" id="email">
                                    @error('email')
                                    <div  class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('division_id') is-invalid @enderror" id="division_id" name="division_id" >
                                        ...
                                        @foreach ( $datas as $item)
                                            <option value="{{ $item->id }}" @if ($data->division_id == $item->id) selected @endif>{{ $item->div_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('division_id')
                                    <div  class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check  mb-3">
                                            <input class="form-check-input" type="checkbox" name="AQUA" value="1" @if($data->AQUA == 1) checked @endif id="AQUA">
                                        ...
                                        <div class="form-check  mb-3">
                                            <input class="form-check-input" type="checkbox" name="FRHPHM" value="1" @if($data->FRHPHM == 1) checked @endif id="FRHPHM">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="form-check  mb-3">
                                            <input class="form-check-input" type="checkbox" @if($data->IT_CELL == 1) checked @endif name="IT_CELL" value="1" id="IT-CELL">
                                        ...
                                        <div class="form-check  mb-3">
                                            <input class="form-check-input" type="checkbox" @if($data->FINANCE == 1) checked @endif name="FINANCE" value="1" id="FINANCE">
